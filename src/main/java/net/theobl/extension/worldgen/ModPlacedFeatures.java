...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> SMALL_DARK_OAK_PLACED_KEY = registerKey("samll_dark_oak_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, SMALL_DARK_OAK_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.SMALL_DARK_OAK_KEY),
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Extension.MOD_ID, name));
    }
